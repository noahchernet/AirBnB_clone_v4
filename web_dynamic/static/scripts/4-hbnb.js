$('document').ready(function () {
  ...
  $('button').click(function () {
    const selectedAmenitiesIdsJSON = $('.amenities input[type=checkbox]:checked').map(function (i, v) { return v.parentElement.dataset.id; });
    // console.log(selectedAmenitiesIdsJSON);
    const amenitiesList = [];

    console.log('Amenities length: ' + selectedAmenitiesIdsJSON.length);
